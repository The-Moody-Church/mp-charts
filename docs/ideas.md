...
`set-state-in-effect` is at **4 of 18** remaining and stays `warn` until the last site lands. Full per-site plan, risk ranking, traps and manual test checklist: `.claude/notes/react-compiler-lint-plan.md`.
