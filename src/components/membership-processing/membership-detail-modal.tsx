          ...
          <div className="space-y-4 mt-2">
            ...
            {(info.Email_Address || info.Mobile_Phone) && (
              <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
                {info.Email_Address && (
                  <a href={`mailto:${info.Email_Address}`} className="text-blue-600 hover:underline inline-flex items-center gap-1">
                    <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {info.Mobile_Phone && (
                  <a href={`tel:${info.Mobile_Phone}`} className="text-blue-600 hover:underline inline-flex items-center gap-1">
                    <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
